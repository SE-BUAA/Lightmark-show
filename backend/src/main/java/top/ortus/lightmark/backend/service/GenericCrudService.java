...
import top.ortus.lightmark.backend.config.lightmarkDatabaseProperties;
...
public class GenericCrudService {
    ...
    private final lightmarkDatabaseProperties databaseProperties;
    ...
    public GenericCrudService(JdbcTemplate jdbcTemplate,
                              ...
                              lightmarkDatabaseProperties databaseProperties,
