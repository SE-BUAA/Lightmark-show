...
public class DatabaseCompatibilityMigrator implements ApplicationRunner {
    ...
    public DatabaseCompatibilityMigrator(
        ...
        @Value("${lightmark.database.compatibility.bulk-seed-enabled:false}") boolean bulkSeedEnabled
    ) {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (bulkSeedEnabled) {
            ...
            log.info("Bulk product seed skipped. Set lightmark.database.compatibility.bulk-seed-enabled=true to enable it.");
        }
    }
